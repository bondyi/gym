...
namespace Gym.ASP.Views
{
    public class FeedbacksController : Controller
    {
        ...
        public FeedbacksController(GymContext context)
        {
            _context = context;
        }
        ...
        {
            var gymContext = _context.Feedbacks.Include(f => f.Client).Include(f => f.Trainer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeedbackId,ClientId,TrainerId,Rating,Message,CreationDate")] Feedback feedback)
        {
